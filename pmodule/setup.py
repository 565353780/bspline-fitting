...
safe_bs_fit_sources = []
for source in bs_fit_sources:
    if 'main.cpp' in source:
        continue
    safe_bs_fit_sources.append(source)
...
if torch.cuda.is_available():
    ...
    safe_bs_fit_sources += glob.glob(bs_fit_src_path + "*.cu")
